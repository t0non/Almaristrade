...
import { Playfair_Display, Source_Sans_3, Barlow } from "next/font/google";
import "./globals.css";
import HeaderHero from "@/components/HeaderHero";
import Footer from "@/components/Footer";
import Script from "next/script";

// Playfair Display: serif clássico e elegante — ideal para títulos institucionais
...
// Source Sans 3: sans-serif profissional de alta legibilidade — corpo e interface
...
// Barlow: geométrico condensado — labels, navegação e UI institucional
...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR" className={`${displayFont.variable} ${sansFont.variable} ${barlowFont.variable}`}>
