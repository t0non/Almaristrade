        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-gray-600 text-base leading-relaxed">
                A <strong className="text-graphite-900 font-semibold">Almaris International Trade Ltda.</strong> (CNPJ: 24.249.746/0001-00) não atua com intermediários desnecessários. Com um capital social integralizado de R$ 1,25 milhão, garantimos solidez financeira para conectar origens agrícolas e minerais brasileiras qualificadas a refinarias, indústrias e compradores internacionais de forma direta, transparente e rastreável.
              </p>
            </div>

            <div className="lg:col-span-5 bg-navy-900 text-white p-8 md:p-10 border border-white/10 space-y-6">
              <span className="text-xs font-semibold uppercase tracking-[0.2em] text-gold-600">Manifesto Corporativo</span>
              <p className="font-interface text-2xl italic leading-snug">
          ...
          <div className="mt-16 border border-border-200 divide-y divide-border-200 max-w-3xl mx-auto bg-ivory-50">
            <div className="px-6 py-4 bg-navy-900 text-white">
              <h3 className="font-interface text-lg font-semibold">Dados Societários</h3>
            </div>
            {[
              { label: 'Razão Social', value: 'Almaris International Trade Ltda.' },
              { label: 'CNPJ', value: '24.249.746/0001-00' },
              { label: 'Abertura', value: '24 de fevereiro de 2016' },
              { label: 'Sede Administrativa', value: 'São Paulo/SP — Brasil' },
              { label: 'Capital Social', value: 'R$ 1.250.000,00' },
              { label: 'Situação Cadastral', value: 'Ativa' },
            ].map(item => (
              <div key={item.label} className="grid grid-cols-2 px-6 py-4 text-sm">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white p-6 border border-border-200 space-y-3">
              <span className="font-interface text-2xl font-bold text-gold-600">2016</span>
            ...
            <div className="bg-white p-6 border border-border-200 space-y-3">
              <span className="font-interface text-2xl font-bold text-gold-600">2019</span>
            ...
            <div className="bg-white p-6 border border-border-200 space-y-3">
              <span className="font-interface text-2xl font-bold text-gold-600">2022</span>
            ...
            <div className="bg-white p-6 border border-border-200 space-y-3">
              <span className="font-interface text-2xl font-bold text-gold-600">Presente</span>
