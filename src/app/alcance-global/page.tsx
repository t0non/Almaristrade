        ...
        <div className="container-custom">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-gray-600 text-lg font-light leading-relaxed">
              A partir de nossa sede em São Paulo, operamos o escoamento marítimo pelos principais portos do Brasil para atender compradores no Mercosul, União Europeia, Oriente Médio e Ãsia.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 border border-border-200 space-y-3">
              ...
              <h3 className="font-interface text-xl font-semibold text-navy-800">Origens & Fluxos Regionais</h3>
            ...
            <div className="p-6 border border-border-200 space-y-3">
              ...
              <h3 className="font-interface text-xl font-semibold text-navy-800">Expansão para Valência*</h3>
              <p className="text-xs text-gray-600 leading-relaxed">
            ...
            <div className="p-6 border border-border-200 space-y-3">
              ...
              <h3 className="font-interface text-xl font-semibold text-navy-800">Mercados de Commodities</h3>
              <p className="text-xs text-gray-600 leading-relaxed">
