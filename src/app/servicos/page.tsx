...
export default function ServicesPage() {
  const steps = [
    {
      num: '01',
      title: 'Inteligência de Mercado e Originação',
      subtitle: 'Assessoria de comércio exterior, busca e qualificação',
      desc: 'Análise de viabilidade, mapeamento estratégico de fornecedores e seleção rigorosa de origens no Brasil. Auditamos capacidade volumétrica, licenças operacionais e regularidade fiscal antes de qualquer operação.'
    },
    {
      num: '02',
            ...
            {steps.map((step, idx) => (
              ...
              >
                <div className="lg:col-span-3 flex items-center gap-4">
                  <span className="font-interface text-4xl lg:text-5xl font-semibold text-gold-600">
                    {step.num}
                  </span>
