          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="bg-ivory-50 p-6 border border-border-200 space-y-4">
                <h3 className="font-interface text-xl font-semibold text-navy-800">Qualidade & Inspeção</h3>
              ...
              <div className="bg-navy-900 text-white p-6 border border-white/10 space-y-4">
                <h3 className="font-interface text-xl font-semibold text-white">Observações Comerciais</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {relatedProducts.map((rel) => (
              <div key={rel.slug} className="bg-white border border-border-200 p-5 space-y-3">
                ...
                <h3 className="font-interface text-xl font-semibold text-navy-800">{rel.title}</h3>
