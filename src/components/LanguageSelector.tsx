...
const LANGUAGES: LanguageOption[] = [
  ...
  { code: 'ES', label: 'EspaÃ±ol', flag: 'es', country: 'Espanha' },
  { code: 'ZH', label: 'ä¸­æ–‡ (Chinese)', flag: 'cn', country: 'China' },
  { code: 'FR', label: 'Français', flag: 'fr', country: 'França' },
  { code: 'RU', label: 'Ð ÑƒÑÑÐºÐ¸Ð¹', flag: 'ru', country: 'Rússia' },
  { code: 'AR', label: 'Ø§Ù„Ø¹Ø±Ø¨ÙŠØ© (Arabic)', flag: 'ae', country: 'Liga Ãrabe' },
];
